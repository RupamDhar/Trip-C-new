...
const TravelSolutions = () => {
    ...
    return (
        < div className="premium-travel-solutions mt-[100px] flex flex-col justify-center items-center h-fit w-screen box-border bg-white" >
            ...
            <div className="premium-travel-solutions-wrapper w-3/4 sm-max:w-full">
                <div className="travel-solution flex justify-evenly items-center mb-[80px] sm-max:mb-[40px] sm-max:p-[0_10px] sm-max:flex-wrap transition-all duration-200 ease hidden-sol-left transform translate-x-[-100px] sm-max:translate-x-[-50px] opacity-0">
                    <img src="	https://img.freepik.com/free-photo/handsome-bearded-manager-entering-his-car-while-standing-outdoors-streets-city-near-modern-office-center_496169-510.jpg?uid=P77132068&ga=GA1.1.1678051510.1721624355&semt=ais_user-customized" className='travel-solution-img rounded-lg w-[500px] h-[370px] sm-max:w-full sm-max:h-auto sm-max:mb-[10px]' alt="" />
                ...
                <div className="travel-solution flex justify-evenly items-center mb-[80px] sm-max:mb-[40px] sm-max:p-[0_10px] sm-max:flex-wrap transition-all duration-200 ease hidden-sol-right transform translate-x-[100px] sm-max:translate-x-[50px] opacity-0 sm-max:flex-col-reverse">
                    ...
                    <img src="https://img.freepik.com/free-photo/handsome-bearded-smiling-businessman-working-his-laptopand-speaking-mobile-phone-backseat-car_496169-578.jpg?uid=P77132068&ga=GA1.1.1678051510.1721624355&semt=ais_user-customized" className='travel-solution-img rounded-lg w-[500px] h-[370px] sm-max:w-full sm-max:h-auto sm-max:mb-[10px]' alt="" />
                </div>

                <div className="travel-solution flex justify-evenly items-center mb-[80px] sm-max:mb-[40px] sm-max:p-[0_10px] sm-max:flex-wrap transition-all duration-200 ease hidden-sol-left transform translate-x-[-100px] sm-max:translate-x-[-50px] opacity-0">
                    <img src="https://img.freepik.com/free-photo/jumbo-jet-flying-sky_23-2150895689.jpg?uid=P77132068&ga=GA1.1.1678051510.1721624355&semt=ais_user-customized" className='travel-solution-img rounded-lg w-[500px] h-[370px] sm-max:w-full sm-max:h-auto sm-max:mb-[10px]' alt="" />
                    <div className="travel-solution-info">
                        <span className="travel-sol-info-header text-[28px] font-bold text-[#191f1a] cursor-pointer sm-max:mt-[10px] sm-max:text-[16px]">
                ...
                <div className="travel-solution flex justify-evenly items-center mb-[80px] sm-max:mb-[40px] sm-max:p-[0_10px] sm-max:flex-wrap transition-all duration-200 ease hidden-sol-right transform translate-x-[100px] sm-max:translate-x-[50px] opacity-0 sm-max:flex-col-reverse">
                    ...
                    <img src="https://img.freepik.com/premium-photo/auto-business-car-sale-consumerism-people-concept-happy-woman-with-car-dealer-auto-show-salon_380164-111922.jpg?uid=P77132068&ga=GA1.1.1678051510.1721624355" className='travel-solution-img rounded-lg w-[500px] h-[370px] sm-max:w-full sm-max:h-auto sm-max:mb-[10px]' alt="" />
                </div>

                <div className="travel-solution flex justify-evenly items-center mb-[80px] sm-max:mb-[40px] sm-max:p-[0_10px] sm-max:flex-wrap transition-all duration-200 ease hidden-sol-left transform translate-x-[-100px] sm-max:translate-x-[-50px] opacity-0">
                    <img src="https://img.freepik.com/premium-photo/female-chauffeur-helps-business-people-get-out-vehicle_506452-23518.jpg?uid=P77132068&ga=GA1.1.1678051510.1721624355&semt=ais_user-customized" className='travel-solution-img rounded-lg w-[500px] h-[370px] sm-max:w-full sm-max:h-auto sm-max:mb-[10px]' alt="" />
                    <div className="travel-solution-info">
                        <span className="travel-sol-info-header text-[28px] font-bold text-[#191f1a] cursor-pointer sm-max:mt-[10px] sm-max:text-[16px]">
