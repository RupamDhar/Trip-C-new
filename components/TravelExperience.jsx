...
const TravelExperience = () => {
  ...
  return (
    <div className="elevate-travel-experiences-section box-border overflow-hidden flex flex-col justify-center items-center h-fit w-screen py-[60px] pb-[0px] box-border bg-[#dc635b]">
      ...
      <div className="travel-experience-offerings w-screen mt-[40px] flex justify-center items-center gap-[35px] sm-max:flex-col sm-max:p-[10px] sm-max:gap-[10px]">
        <div className="travel-experience-offerings-left h-[550px] w-[100%] sm-max:w-[100%] sm-max:h-fit" >
          <img src="/top_ph002.png" className='offering-img left object-cover rounded-lg h-[100%] sm-max:h-[100%] sm-max:w-[100%]' alt="" data-aos="fade-right" data-aos-delay="100" />
        </div>
